...
textos = [
    ...
    "Carro autonômo da Waymo",
    "Vitória do Trump nas eleições americanas",
    "Palmeira perde jogo para o corinthians"
]
categorias = ["tecnologia", "esportes", "política", "tecnologia", "esportes", "política", "tecnologia", "política", "esportes"]
